...
class CustomTableModel(QSqlQueryModel):
    def setUserId(self, user_id):
        self.setQuery(f"SELECT * FROM expenses WHERE UserID = {user_id}")
...
class ExpenseTracker(QMainWindow):
    ...
    def view_data(self):
        self.custom_model = CustomTableModel(self)
        self.custom_model.setUserId(self.conn.get_user_id())
        self.ui.tableView.setModel(self.custom_model)
...
if __name__ == "__main__":
    ...
    # Вполнение програмы ыначитать с запуска файла authorization
